...
t_dob_enhanced = Table("cleaned_2", *dob_columns_reshaping, from_table=t_dob_basic_cleaned)
...
t_name_enhanced = Table("cleaned_2", *name_columns_reshaping, from_table=t_name_basic_cleaned)
t_name_simple_select = Table("cleaned_3", *name_columns_simple_select, from_table=t_name_enhanced)
...
t_sentence_date_basic = Table("cleaned_1", *sentence_date_columns_basic, from_table="input_table")
t_sentence_date_enhanced = Table("cleaned_2", *sentence_date_columns_reshaping, from_table=t_sentence_date_basic)
