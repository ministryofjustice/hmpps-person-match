...
class OpenAPIConfig:
    ...
    DOCS_URL: ClassVar[str] = "/swagger-ui.html"
    APPLICATION_TITLE: ClassVar[str] = "HMPPS Person Match"
    APPLICATION_SUMMARY: ClassVar[str] = """
    ...
    """
    APPLICATION_DESCRIPTION: ClassVar[str] = """
    ...
    """
    APPLICATION_VERSION: ClassVar[str] = "0.1.0"
    DEFAULT_RESPONSES: ClassVar[dict] = {
        400: {
