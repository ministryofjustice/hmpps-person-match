...
def downgrade() -> None:
    op.drop_column(table_name="person", column_name="postcode_first")
    op.drop_column(table_name="person", column_name="postcode_second")
    op.drop_column(table_name="person", column_name="postcode_last")
    op.drop_column(table_name="person", column_name="postcode_outcode_first")
    op.drop_column(table_name="person", column_name="postcode_outcode_last")
    op.drop_column(table_name="person", column_name="date_of_birth_last")
    op.drop_column(table_name="person", column_name="forename_first")
    op.drop_column(table_name="person", column_name="forename_last")
    op.drop_column(table_name="person", column_name="last_name_first")
    op.drop_column(table_name="person", column_name="last_name_last")
    op.drop_column(table_name="person", column_name="sentence_date_first")
    op.drop_column(table_name="person", column_name="sentence_date_last")
