...
from hmpps_person_match.models.person.person_search_request import PersonSearchRequest
...
async def post_person_search(
    ...
    scored_candidates = await search.search_candidates(search_request, session)
    logger.info(
