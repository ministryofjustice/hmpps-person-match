...
class TestHealthView:
    ...
    def test_response_ok(self, client, mock_db_session):
        """
        Test a get to the health endpoint returns a 200 ok
        """
        # Mock db response
        mock_db_session.exec.return_value.first.return_value = 1
    ...
    def test_response_no_db_con(self, client, mock_db_session):
        """
